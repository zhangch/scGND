---
title: "Slingshot Trajectory whith Data planaria-pair-10_plass"
author: "ycliu"
date: "09/25/2023"
output:
  html_notebook
...
expression_data <- read.csv("/projectnb/czproj/Algorithms/ycliu/traj_data_real/planaria-pair-10_plass_count.csv", row.names = 1, header = TRUE)
...
cluster_labels <- read.csv("/projectnb/czproj/Algorithms/ycliu/traj_data_real/planaria-pair-10_plass_clusters.csv", header = TRUE)
...
DimPlot(seurat_obj, reduction = "umap", group.by= 'seurat_clusters' ) + ggtitle('Groups')
...
```{r, echo=FALSE}
# Perform trajectory inference
sds <- getLineages(sds, start.clus='11')
sds <- getCurves(sds)
