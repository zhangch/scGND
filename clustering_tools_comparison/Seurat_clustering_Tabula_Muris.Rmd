---
title: "Clustering for Tabula_Muris data"
author: "K4"
date: "06/28/2023"
output:
  html_notebook
...
suffix <- "Seurat"
sampleName <- "Tabula_Muris"
rawDataDir <- "scGND/data/Tabula_Muris/ME_V2/outputs"
projectName <- "Tabula_Muris"
...
```{r, eval = set_eval, echo=FALSE}
# clustering
data <- FindNeighbors(data, k.param = 20, reduction = "pca", dims=1:50)
data <- FindClusters(data, resolution = 0.02)
```
